...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sqlServerLegacyUnencryptedModeEnable: "使用 SQL Server 旧版TLS 1.0非加密连接",
    sqlServerLegacyUnencryptedModeEnabled: "已启用 SQL Server 旧版兼容模式。",
    sqlServerLegacyUnencryptedModeHint: "适用于非加密或仅登录阶段加密的场景。若服务端强制 TLS 1.0 加密，此模式仍会失败\n请仅在可信内网、VPN 或 SSH 隧道中使用",
  ...
  transfer: {
    ...
    taskDeleted: "传输任务已删除",
    taskNeverRun: "从未执行",
    taskLastRun: "上次执行：{time}",
    taskMeta: "{tables} 张表 · {mode}",
    executeConfirmTitle: "执行传输任务",
    executeConfirmMessage: "将按已保存的配置开始数据传输，请确认后继续。",
    yes: "是",
    no: "否",
  },
  tableImport: {
  ...
  settings: {
    ...
    updateDownloadSourceDescription: "选择应用内更新安装包的下载来源。官方源为推荐选项，CNB 适合国内网络环境。",

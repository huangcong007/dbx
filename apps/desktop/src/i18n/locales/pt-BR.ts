...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sqlServerLegacyUnencryptedModeEnable: "Usar conexão SQL Server legada TLS 1.0 não criptografada",
    sqlServerLegacyUnencryptedModeEnabled: "O modo de compatibilidade legado do SQL Server está ativado.",
    sqlServerLegacyUnencryptedModeHint: "Aplica-se a transporte não criptografado ou criptografia apenas no login. Ainda falhará se o servidor exigir criptografia TLS 1.0.\nUse apenas em redes confiáveis, VPNs ou túneis SSH",
  ...
  etcd: {
    prefixPlaceholder: "Prefixo, ex.: /app/",
    newKey: "Nova Chave",
  ...
  transfer: {
    ...
    parallelTables: "Tabelas paralelas",
    skipCount: "Pular contagem de linhas",
  ...
  settings: {
    ...
    updateDownloadSourceDescription: "Escolha de onde os instaladores de atualização no aplicativo são baixados. A fonte oficial é recomendada; CNB ou AtomGit podem ser mais rápidos em redes da China continental.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Deixe vazio para o Nacos gerar",

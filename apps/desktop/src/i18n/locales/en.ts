export default {
  ...
  transfer: {
    ...
    noSavedTasks: "No saved transfer tasks yet",
    ...
    taskSaved: "Transfer task saved",
    taskDeleted: "Transfer task deleted",
    taskNeverRun: "Never run",
    taskLastRun: "Last run: {time}",
    taskMeta: "{tables} table(s) · {mode}",
    executeConfirmTitle: "Execute transfer task",
    executeConfirmMessage: "This will start a data transfer with the saved configuration. Please confirm before continuing.",
    yes: "Yes",
    no: "No",
  },
  tableImport: {
